    ...
    <li v-for="comment in props.comments" :key="comment.id" class="space-y-2">
      <article class="comment-row">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div class="flex w-full flex-wrap items-center gap-1.5 sm:w-auto sm:shrink-0 sm:justify-end sm:gap-2">
            <button
              type="button"
              class="btn-secondary icon-btn min-h-9 px-2 py-1 text-xs"
            ...
            <button
              ...
              type="button"
              class="btn-danger icon-btn min-h-9 px-2 py-1 text-xs"
        ...
        <div v-if="props.activeReplyCommentId === comment.id" class="flex flex-col gap-2 sm:flex-row">
          <input
      ...
      <div v-if="comment.replies && comment.replies.length > 0" class="border-l-2 border-zinc-200 pl-2 dark:border-zinc-700 sm:pl-3">
        <BookCommentThread
